                ...
                <>
                    ...
                    <Card className="card-wrap">
                        <CardContent>
                            ...
                            <hr />
                            <StatsGraph confirmed={cases.totalconfirmed}
                                active={cases.totalconfirmed - cases.totaldeceased - cases.totalrecovered}
                    ...
                    <Card className="card-wrap">
                        <CardContent>
                            <Typography color="textSecondary" gutterBottom>
                                Total Tested samples <strong>{tested.totalsamplestested}</strong>
                            </Typography>
                        </CardContent>
                    </Card>
                </>
