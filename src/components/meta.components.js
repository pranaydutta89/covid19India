...
const metaInfos = {
    ...
    '/india': {
        ...
        description:
            `Get latest covid19 sarc-cov-2 outbreak data for India, get confirmed, deaths ,recovered, active cases count for India, get number of test India did till date, get previous date confirmed, recovered ,deaths cases counts`,
